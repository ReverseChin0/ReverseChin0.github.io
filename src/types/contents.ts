...
export const EN_AboutCont:BaseContent = { //ya
  ...
  '🕹 I have experience working in Unity with C# and Unreal Engine with Blueprints and a bit of C++', 
  '⚛ I Know how to use React, Javascript, and authentication in Firebase.', 
